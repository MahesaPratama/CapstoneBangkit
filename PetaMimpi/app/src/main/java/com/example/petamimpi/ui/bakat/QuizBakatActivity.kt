...
data class BakatOptionValue(val name: String)

class QuizBakatActivity : ComponentActivity() {
...
fun QuizBakatList() {
    ...
    val apiUrl = "https://petamimpi-api-408806.et.r.appspot.com/talent-questions"
    val selectedOptionsListByQuiz by remember { mutableStateOf(mutableMapOf<String, BakatOptionValue>()) }
            ...
            items(quizList) { quiz ->
                Box(
                    ...
                    Column {
                        ...
                        var selectedOption by remember { mutableStateOf<BakatOptionValue?>(null) }

                        for (option in listOf(
                            BakatOptionValue("Ya"),
                            BakatOptionValue("Tidak"),
                        )) {
                            QuizBakatOption(option = option,
...
@Composable
fun SubmitButton(selectedOptionsListByQuiz: MutableMap<String, BakatOptionValue>) {
    ...
    ElevatedButton(
        onClick = {
            val intent = Intent(context, ResultBakatActivity::class.java)
...
//                        "https://petamimpi-api-408806.et.r.appspot.com/calculate-talent",
//                        jsonString
//                    )
...
@Composable
fun QuizBakatOption(
    option: BakatOptionValue,
    isSelected: Boolean,
    onClick: (BakatOptionValue) -> Unit
) {
